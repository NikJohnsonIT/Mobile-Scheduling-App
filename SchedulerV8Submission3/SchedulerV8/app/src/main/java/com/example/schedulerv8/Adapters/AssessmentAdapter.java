...
public class AssessmentAdapter extends RecyclerView.Adapter<AssessmentAdapter.AssessmentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AssessmentAdapter.AssessmentViewHolder holder, int position) {
        if(mAllAssessments!=null){
            ...
            intent.putExtra("assessment_course_id", currentAssessment.getCourseId());
            intent.putExtra("assessment_title", currentAssessment.getAssessmentTitle());
            intent.putExtra("assessment_start_date", currentAssessment.getAssessmentStartDate());
            intent.putExtra("assessment_end_date", currentAssessment.getAssessmentEndDate());
            intent.putExtra("assessment_type", currentAssessment.getAssessmentType());
    ...
    public void setAssociatedAssessments(List<Assessment> associatedAssessments) {
        mAssociatedAssessments = associatedAssessments;
        notifyDataSetChanged();
    }
}
